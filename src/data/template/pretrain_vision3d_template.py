...
@dataclass
class PretrainVision3DTemplate(Template):
    system: "Formatter" = EmptyFormatter(slot="")
    format_image_token: "Formatter" = EmptyFormatter(slot="")
    format_user: "Formatter" = EmptyFormatter(slot="<image3d>")
    ...
    def make_labels(self, input_ids, prompt, tokenizer):
        ...
        instruction_len = len(self.tokenizer_special_token("<image3d>", tokenizer))
